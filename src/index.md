...
title: Let's play some baseball games!
layout: page
excerpt: # used for page excerpts and META (will be overwritten if SEO used below)
author: hunter-baun # only displayed on Post lists and detail views. Defaults to _data/meta.authorURL
...
heroSettings:
  ...
  bg:
    ...
    image: common/PowerfulPros2022_clouds.png # relative to /assets/images/
    imagePosition: # options = bg-center (default), bg-left, bg-right
    # video: pixabay-john-macdougall.mp4 # local relative /assets/video/, or full https://... if remote?
    opacityMobile: opacity-75 # options opacity-n, 5, 10, 15, 20, 25, 50, 75, 100 (default)
    opacityDesktop: opacity-75 # Leave blank to inherit opacityMobile, use same options as opacityMobile
  headingText: It'd be pretty cool if you could understand enough to play some of these Japanese baseball video games, right?
  headingTextColor: # default = text-white (can use any TailwindCSS text-[color]-[xxx])
  headingTextCase: # default = as typed - options: uppercase, lowercase, capitalize
  subheadingText: Well, let's get in there and get you playing, eh?
  subheadingTextColor: # Leave empty to inherit headingTextColor or default (text-white) or use any text-[color]-[xxx]
  buttonText: 野球しようよ！ # no button generated if left blank
  buttonURL: /games/ # full url required. Example: https://thisdomain.com/somepage/
